...
matfile = sprintf('%s','wrist_results_10_14_no_filter');
%
...
save_file = sprintf('%s','wrist_Posture_condition-ept_shaded_10_14');
...
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_Rest_condition-ept_shaded_10_14');
print(gcf,save_file,'-dpng','-r1200');
...
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_loaded_condition-ept_shaded_10_14');
print(gcf,save_file,'-dpng','-r1200');
...
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_preMVC-ept_shaded_10_14');
print(gcf,save_file,'-dpng','-r1200');
...
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_postMVC-ept_shaded_10_14');
print(gcf,save_file,'-dpng','-r1200');
...
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_pre_and_postMVC-ept_shaded_10_14');
print(gcf,save_file,'-dpng','-r1200');
...
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_first_and_last_30_MVC-ept_shaded_10_14');
print(gcf,save_file,'-dpng','-r1200');
