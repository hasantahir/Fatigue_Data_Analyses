...
for n = setdiff( 1 : 15, [4 7])
    plot(PC{n}.psd_peak, '--s', 'MarkerSize', 7.5,...
...
save_file = sprintf('%s','wrist_Posture_condition-psd_values');
...
RC = table_stats.RC;
for n = setdiff( 1 : 15, [4 7])
    plot(RC{n}.psd_peak, '--s', 'MarkerSize', 7.5,...
        'MarkerFaceColor', color(n, :),...
        'MarkerEdgeColor','black');
    hold on
end
...
legend(Legend,'Location','NorthEastOutside')
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_Rest_condition-psd_values');
print(gcf,save_file,'-dpng','-r1200');
...
LPC = table_stats.LPC;
for n = setdiff( 1 : 15, [4 7])
    plot(LPC{n}.psd_peak, '--s', 'MarkerSize', 7.5,...
        'MarkerFaceColor', color(n, :),...
        'MarkerEdgeColor','black');
    hold on
end
...
legend(Legend,'Location','NorthEastOutside')
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_LPC-psd_values');
print(gcf,save_file,'-dpng','-r1200');
...
preMVC_cat = [];
for n = setdiff( 1 : 15, [4 7])
    plot(pre_MVC{n}.psd_peak, '--s', 'MarkerSize', 7.5,...
        'MarkerFaceColor', color(n, :),...
        'MarkerEdgeColor','black');
    hold on
    preMVC_cat = horzcat(preMVC_cat, pre_MVC{n}.psd_peak);
end
...
legend(Legend,'Location','NorthEastOutside')
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_preMVC-psd_values');
print(gcf,save_file,'-dpng','-r1200');
...
postMVC_cat = [];
for n = setdiff( 1 : 15, [4 7])
    plot(post_MVC{n}.psd_peak, '--s', 'MarkerSize', 7.5,...
        'MarkerFaceColor', color(n, :),...
        'MarkerEdgeColor','black');
    postMVC_cat = horzcat(postMVC_cat, post_MVC{n}.psd_peak);
    hold on
end
...
legend(Legend,'Location','NorthEastOutside')
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_postMVC-psd_values');
print(gcf,save_file,'-dpng','-r1200');
...
legend(Legend,'Location','NorthEastOutside')
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_pre_and_postMVC-psd_values');
print(gcf,save_file,'-dpng','-r1200');
...
for n = setdiff( 1 : 15, [4 7])
    first1 = first{n}.psd_peak;
    last1 = last{n}.psd_peak;
...
% xlabel('Minutes after exhaustion')
ylabel('PSD (Hz)')
title('Wrist - PSD Peak  - First and last four 30 % MVC')
%axP = get(gca,'Position');
legend(Legend,'Location','NorthEastOutside')
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_first_and_last_30_MVC-psd_values');
print(gcf,save_file,'-dpng','-r1200');
