...
save_file = sprintf('%s','wrist_no_filter_Posture_condition-psd_auc');
...
legend(Legend,'Location','NorthEastOutside')
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_no_filter_Rest_condition-psd_auc');
print(gcf,save_file,'-dpng','-r1200');
...
legend(Legend,'Location','NorthEastOutside')
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_no_filter_LPC-psd_auc');
print(gcf,save_file,'-dpng','-r1200');
...
legend(Legend,'Location','NorthEastOutside')
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_no_filter_preMVC-psd_auc');
print(gcf,save_file,'-dpng','-r1200');
...
legend(Legend,'Location','NorthEastOutside')
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_no_filter_postMVC-psd_auc');
print(gcf,save_file,'-dpng','-r1200');
...
% legend(Legend,'Location','NorthEastOutside')
% % set(gca, 'Position', axP)
% save_file = sprintf('%s','wrist_no_filter_pre_and_postMVC-psd_auc');
% print(gcf,save_file,'-dpng','-r1200');
...
legend(Legend,'Location','NorthEastOutside')
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_no_filter_first_and_last_30_MVC-psd_auc');
print(gcf,save_file,'-dpng','-r1200');
