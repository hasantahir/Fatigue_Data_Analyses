...
for n = setdiff( 1 : 15, [2 4 6 7 8 10 11 13])
...
save_file = sprintf('%s','wrist_Posture_condition-ept_shaded_3_8_fatigued');
...
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_Rest_condition-ept_shaded_3_8_fatigued');
print(gcf,save_file,'-dpng','-r1200');
...
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_loaded_condition-ept_shaded_3_8_fatigued');
print(gcf,save_file,'-dpng','-r1200');
...
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_preMVC-ept_shaded_3_8_fatigued');
print(gcf,save_file,'-dpng','-r1200');
...
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_postMVC-ept_shaded_3_8_fatigued');
print(gcf,save_file,'-dpng','-r1200');
...
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_pre_and_postMVC-ept_shaded_3_8_fatigued');
print(gcf,save_file,'-dpng','-r1200');
...
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_first_and_last_30_MVC-ept_shaded_3_8_fatigued');
print(gcf,save_file,'-dpng','-r1200');
