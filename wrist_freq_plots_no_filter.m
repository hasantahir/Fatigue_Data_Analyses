...
for n = setdiff( 1 : 15, [4 7])
    plot(PC{n}.freq_peak, '--s', 'MarkerSize', 7.5,...
...
ylabel('Frequency (Hz)')
title('Wrist - Freq Peak  - Posture Condition')
%axP = get(gca,'Position');
legend(Legend,'Location','NorthEastOutside')
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_no_filter_Posture_condition-freq_values');
...
RC = table_stats.RC;
for n = setdiff( 1 : 15, [4 7])
    plot(RC{n}.freq_peak, '--s', 'MarkerSize', 7.5,...
        'MarkerFaceColor', color(n, :),...
        'MarkerEdgeColor','black');
    hold on
end
...
% xlabel('Minutes after exhaustion')
ylabel('Frequency (Hz)')
title('Wrist - Freq Peak  - Rest Condition')
%axP = get(gca,'Position');
legend(Legend,'Location','NorthEastOutside')
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_no_filter_Rest_condition-freq_values');
print(gcf,save_file,'-dpng','-r1200');
...
LPC = table_stats.LPC;
for n = setdiff( 1 : 15, [4 7])
    plot(LPC{n}.freq_peak, '--s', 'MarkerSize', 7.5,...
        'MarkerFaceColor', color(n, :),...
        'MarkerEdgeColor','black');
    hold on
end
...
% xlabel('Minutes after exhaustion')
ylabel('Frequency (Hz)')
title('Wrist - Freq Peak  - Loaded Posture Condition')
%axP = get(gca,'Position');
legend(Legend,'Location','NorthEastOutside')
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_no_filter_LPC-freq_values');
print(gcf,save_file,'-dpng','-r1200');
...
preMVC_cat = [];
for n = setdiff( 1 : 15, [4 7])
    plot(pre_MVC{n}.freq_peak, '--s', 'MarkerSize', 7.5,...
        'MarkerFaceColor', color(n, :),...
        'MarkerEdgeColor','black');
    hold on
    preMVC_cat = horzcat(preMVC_cat, pre_MVC{n}.freq_peak);
end
...
% xlabel('Minutes after exhaustion')
ylabel('Frequency (Hz)')
title('Wrist - Freq Peak  - Pre MVC')
%axP = get(gca,'Position');
legend(Legend,'Location','NorthEastOutside')
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_no_filter_preMVC-freq_values');
print(gcf,save_file,'-dpng','-r1200');
...
postMVC_cat = [];
for n = setdiff( 1 : 15, [4 7])
    plot(post_MVC{n}.freq_peak, '--s', 'MarkerSize', 7.5,...
        'MarkerFaceColor', color(n, :),...
        'MarkerEdgeColor','black');
    postMVC_cat = horzcat(postMVC_cat, post_MVC{n}.freq_peak);
    hold on
end
...
% xlabel('Minutes after exhaustion')
ylabel('Frequency (Hz)')
title('Wrist - Freq Peak  - Post MVC')
%axP = get(gca,'Position');
legend(Legend,'Location','NorthEastOutside')
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_no_filter_postMVC-freq_values');
print(gcf,save_file,'-dpng','-r1200');
...
% xlabel('Minutes after exhaustion')
ylabel('Frequency (Hz)')
title('Wrist - Freq Peak  - Pre and Post MVC')
%axP = get(gca,'Position');
legend(Legend,'Location','NorthEastOutside')
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_no_filter_pre_and_postMVC-freq_values');
print(gcf,save_file,'-dpng','-r1200');
...
for n = setdiff( 1 : 15, [4 7])
    first1 = first{n}.freq_peak;
    last1 = last{n}.freq_peak;
...
% xlabel('Minutes after exhaustion')
ylabel('Frequency (Hz)')
title('Wrist - Freq Peak  - First and last four 30 % MVC')
%axP = get(gca,'Position');
legend(Legend,'Location','NorthEastOutside')
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_no_filter_first_and_last_30_MVC-freq_values');
print(gcf,save_file,'-dpng','-r1200');
