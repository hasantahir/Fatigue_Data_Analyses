...
ylabel('PSD %')
% title('Wrist - PSD Distribution in 14-22 Hz  - Posture Condition')
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_Posture_condition-ept_shaded_14_22');
print(gcf,save_file,'-dpng','-r1200');
matlab2tikz('filename',sprintf('wrist_Posture_condition-ept_shaded_14_22.tex'));
savefig('wrist_Posture_condition-ept_shaded_14_22.fig')
...
% xlabel('Minutes after exhaustion')
ylabel('PSD %')
% title('Wrist - PSD Distribution in 14-22 Hz  - Rest Condition')
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_Rest_condition-ept_shaded_14_22');
print(gcf,save_file,'-dpng','-r1200');
matlab2tikz('filename',sprintf('wrist_Rest_condition-ept_shaded_14_22.tex'));
savefig('wrist_Rest_condition-ept_shaded_14_22.fig')
...
% xlabel('Minutes after exhaustion')
ylabel('PSD %')
% title('Wrist - PSD Distribution in 14-22 Hz  - Loaded Posture Condition')
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_loaded_condition-ept_shaded_14_22');
print(gcf,save_file,'-dpng','-r1200');
matlab2tikz('filename',sprintf('wrist_loaded_condition-ept_shaded_14_22.tex'));
savefig('wrist_loaded_condition-ept_shaded_14_22.fig')
...
% xlabel('Minutes after exhaustion')
ylabel('PSD %')
% title('Wrist - PSD Distribution in 14-22 Hz  - Pre MVC')
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_preMVC-ept_shaded_14_22');
print(gcf,save_file,'-dpng','-r1200');
matlab2tikz('filename',sprintf('wrist_preMVC-ept_shaded_14_22.tex'));
savefig('wrist_preMVC-ept_shaded_14_22.fig')
...
% xlabel('Minutes after exhaustion')
ylabel('PSD %')
% title('Wrist - PSD Distribution in 14-22 Hz  - Post MVC')
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_postMVC-ept_shaded_14_22');
print(gcf,save_file,'-dpng','-r1200');
matlab2tikz('filename',sprintf('wrist_postMVC-ept_shaded_14_22.tex'));
savefig('wrist_postMVC-ept_shaded_14_22.fig')
...
% xlabel('Minutes after exhaustion')
ylabel('PSD %')
% title('Wrist - PSD Distribution in 14-22 Hz  - Pre and Post MVC')
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_pre_and_postMVC-ept_shaded_14_22');
print(gcf,save_file,'-dpng','-r1200');
matlab2tikz('filename',sprintf('wrist_pre_and_postMVC-ept_shaded_14_22.tex'));
savefig('wrist_pre_and_postMVC-ept_shaded_14_22.fig')
...
% xlabel('Minutes after exhaustion')
ylabel('PSD %')
% title('Wrist - PSD Distribution in 14-22 Hz  - First and last four 30 % MVC')
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_first_and_last_30_MVC-ept_shaded_14_22');
print(gcf,save_file,'-dpng','-r1200');
matlab2tikz('filename',sprintf('wrist_first_and_last_30_MVC-ept_shaded_14_22.tex'));
savefig('wrist_first_and_last_30_MVC-ept_shaded_14_22.fig')
