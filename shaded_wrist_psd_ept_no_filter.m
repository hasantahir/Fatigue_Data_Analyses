...
save_file = sprintf('%s','wrist_no_filter_Posture_condition-ept_shaded');
...
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_no_filter_Rest_condition-ept_shaded');
print(gcf,save_file,'-dpng','-r1200');
...
shadedErrorBar(x, 100*y, {@mean,@std}, 'lineprops', '-y')
box on; grid on
ax = gca;
set(gcf,'Color','white'); % Set background color to white
set (gca,'FontName','times new roman') % Set axes fonts to Times New Roman
...
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_no_filter_loaded_condition-ept_shaded');
print(gcf,save_file,'-dpng','-r1200');
...
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_no_filter_preMVC-ept_shaded');
print(gcf,save_file,'-dpng','-r1200');
...
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_no_filter_postMVC-ept_shaded');
print(gcf,save_file,'-dpng','-r1200');
...
x=(1:size(CAT,2));
shadedErrorBar(x, 100*CAT, {@mean,@std}, 'lineprops', '-r')
box on; grid on
ax = gca;
set(gcf,'Color','white'); % Set background color to white
set (gca,'FontName','times new roman') % Set axes fonts to Times New Roman
...
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_no_filter_pre_and_postMVC-ept_shaded');
print(gcf,save_file,'-dpng','-r1200');
...
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_no_filter_first_and_last_30_MVC-ept_shaded');
print(gcf,save_file,'-dpng','-r1200');
