...
matfile = sprintf('%s','wrist_results_3_6_no_filter');
%
...
ylabel('PSD %')
title('Wrist - PSD Distribution in 3-6 Hz  - Posture Condition')
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_Posture_condition-ept_shaded_3_6');
...
% xlabel('Minutes after exhaustion')
ylabel('PSD %')
title('Wrist - PSD Distribution in 3-6 Hz  - Rest Condition')
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_Rest_condition-ept_shaded_3_6');
print(gcf,save_file,'-dpng','-r1200');
...
% xlabel('Minutes after exhaustion')
ylabel('PSD %')
title('Wrist - PSD Distribution in 3-6 Hz  - Loaded Posture Condition')
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_loaded_condition-ept_shaded_3_6');
print(gcf,save_file,'-dpng','-r1200');
...
% xlabel('Minutes after exhaustion')
ylabel('PSD %')
title('Wrist - PSD Distribution in 3-6 Hz  - Pre MVC')
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_preMVC-ept_shaded_3_6');
print(gcf,save_file,'-dpng','-r1200');
...
% xlabel('Minutes after exhaustion')
ylabel('PSD %')
title('Wrist - PSD Distribution in 3-6 Hz  - Post MVC')
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_postMVC-ept_shaded_3_6');
print(gcf,save_file,'-dpng','-r1200');
...
% xlabel('Minutes after exhaustion')
ylabel('PSD %')
title('Wrist - PSD Distribution in 3-6 Hz  - Pre and Post MVC')
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_pre_and_postMVC-ept_shaded_3_6');
print(gcf,save_file,'-dpng','-r1200');
...
% xlabel('Minutes after exhaustion')
ylabel('PSD %')
title('Wrist - PSD Distribution in 3-6 Hz  - First and last four 30 % MVC')
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_first_and_last_30_MVC-ept_shaded_3_6');
print(gcf,save_file,'-dpng','-r1200');
