...
save_file = sprintf('%s','wrist_no_filter_Posture_condition-psd_peak_shaded');
...
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_no_filter_Rest_condition-psd_peak_shaded');
print(gcf,save_file,'-dpng','-r1200');
...
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_no_filter_loaded_condition-psd_peak_shaded');
print(gcf,save_file,'-dpng','-r1200');
...
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_no_filter_preMVC-psd_peak_shaded');
print(gcf,save_file,'-dpng','-r1200');
...
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_no_filter_postMVC-psd_peak_shaded');
print(gcf,save_file,'-dpng','-r1200');
...
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_no_filter_pre_and_postMVC-psd_peak_shaded');
print(gcf,save_file,'-dpng','-r1200');
...
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_no_filter_first_and_last_30_MVC-psd_peak_shaded');
print(gcf,save_file,'-dpng','-r1200');
