...
save_file = sprintf('%s','wrist_Posture_condition-rms_peak_shaded');
...
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_Rest_condition-rms_peak_shaded');
print(gcf,save_file,'-dpng','-r1200');
...
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_loaded_condition-rms_peak_shaded');
print(gcf,save_file,'-dpng','-r1200');
...
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_preMVC-rms_peak_shaded');
print(gcf,save_file,'-dpng','-r1200');
...
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_postMVC-rms_peak_shaded');
print(gcf,save_file,'-dpng','-r1200');
...
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_pre_and_postMVC-rms_peak_shaded');
print(gcf,save_file,'-dpng','-r1200');
...
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_first_and_last_30_MVC-rms_peak_shaded');
print(gcf,save_file,'-dpng','-r1200');
