...
matfile = sprintf('%s','wrist_results_8_14_no_filter');
%
...
save_file = sprintf('%s','wrist_Posture_condition-ept_shaded_8_14');
print(gcf,save_file,'-dpng','-r1200');
matlab2tikz('filename',sprintf('wrist_Posture_condition-ept_shaded_8_14.tex'));
savefig('wrist_Posture_condition-ept_shaded_8_14.fig')
...
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_Rest_condition-ept_shaded_8_14');
print(gcf,save_file,'-dpng','-r1200');
matlab2tikz('filename',sprintf('wrist_Rest_condition-ept_shaded_8_14.tex'));
savefig('wrist_Rest_condition-ept_shaded_8_14.fig')
...
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_loaded_condition-ept_shaded_8_14');
print(gcf,save_file,'-dpng','-r1200');
matlab2tikz('filename',sprintf('wrist_loaded_condition-ept_shaded_8_14.tex'));
savefig('wrist_loaded_condition-ept_shaded_8_14.fig')
...
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_preMVC-ept_shaded_8_14');
print(gcf,save_file,'-dpng','-r1200');
matlab2tikz('filename',sprintf('wrist_preMVC-ept_shaded_8_14.tex'));
savefig('wrist_preMVC-ept_shaded_8_14.fig')
...
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_postMVC-ept_shaded_8_14');
print(gcf,save_file,'-dpng','-r1200');
matlab2tikz('filename',sprintf('wrist_postMVC-ept_shaded_8_14.tex'));
savefig('wrist_postMVC-ept_shaded_8_14.fig')
...
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_pre_and_postMVC-ept_shaded_8_14');
print(gcf,save_file,'-dpng','-r1200');
matlab2tikz('filename',sprintf('wrist_pre_and_postMVC-ept_shaded_8_14.tex'));
savefig('wrist_pre_and_postMVC-ept_shaded_8_14.fig')
...
%axP = get(gca,'Position');
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_first_and_last_30_MVC-ept_shaded_8_14');
print(gcf,save_file,'-dpng','-r1200');
matlab2tikz('filename',sprintf('wrist_first_and_last_30_MVC-ept_shaded_8_14.tex'));
savefig('wrist_first_and_last_30_MVC-ept_shaded_8_14.fig')
