...
save_file = sprintf('%s','wrist_Posture_condition-freq_values');
...
legend(Legend,'Location','NorthEastOutside')
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_Rest_condition-freq_values');
print(gcf,save_file,'-dpng','-r1200');
...
legend(Legend,'Location','NorthEastOutside')
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_preMVC-freq_values');
print(gcf,save_file,'-dpng','-r1200');
...
legend(Legend,'Location','NorthEastOutside')
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_postMVC-freq_values');
print(gcf,save_file,'-dpng','-r1200');
...
legend(Legend,'Location','NorthEastOutside')
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_pre_and_postMVC-freq_values');
print(gcf,save_file,'-dpng','-r1200');
...
legend(Legend,'Location','NorthEastOutside')
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_first_and_last_30_MVC-freq_values');
print(gcf,save_file,'-dpng','-r1200');
