...
save_file = sprintf('%s','wrist_Posture_condition-psd_auc');
...
legend(Legend,'Location','NorthEastOutside')
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_Rest_condition-psd_auc');
print(gcf,save_file,'-dpng','-r1200');
...
legend(Legend,'Location','NorthEastOutside')
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_LPC-psd_auc');
print(gcf,save_file,'-dpng','-r1200');
...
legend(Legend,'Location','NorthEastOutside')
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_preMVC-psd_auc');
print(gcf,save_file,'-dpng','-r1200');
...
legend(Legend,'Location','NorthEastOutside')
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_postMVC-psd_auc');
print(gcf,save_file,'-dpng','-r1200');
...
legend(Legend,'Location','NorthEastOutside')
% set(gca, 'Position', axP)
save_file = sprintf('%s','wrist_first_and_last_30_MVC-psd_auc');
print(gcf,save_file,'-dpng','-r1200');
